...
public class BeamUpgradeButton : MonoBehaviour, IPointerClickHandler
{
    ...
    public void LevelViewChange()
    {
        ...
        {
            int currentLevel = upgradeManager.BeamLevel;
            _lvAmount.text = currentLevel.ToString();
            int nextCost = _upgradeCostConfig.GetBeamCost(currentLevel);
