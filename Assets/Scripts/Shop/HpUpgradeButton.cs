...
public class HPUpgradeButton : MonoBehaviour, IPointerClickHandler
{
    ...
    public void LevelViewChange()
    {
        ...
        {
            int currentLevel = upgradeManager.HpLevel;
            _lvAmount.text = currentLevel.ToString();
            int nextCost = _upgradeCostConfig.GetHPCost(currentLevel);
